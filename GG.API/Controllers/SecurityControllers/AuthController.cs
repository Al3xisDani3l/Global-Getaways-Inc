...
namespace GG.Api.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        private readonly IAccountRepository _securityService;
        private readonly IPasswordService _passwordService;
        private readonly IMapper _mapper;

        public AuthController(IConfiguration configuration, IAccountRepository securityService, IPasswordService passwordService, IMapper mapper)
        {
        ...
        public async Task<ActionResult<Session>> Login(UserLogin login)
        {
            try
            {
                ...
                var validation = _passwordService.Check(user.Password, login.Password);
        ...
        public async Task<ActionResult<Session>> SingUp(UserSignUp userSignUp)
        {
            try
            {
                ...
                var created = await _securityService.RegisterUser(userSignUp);
