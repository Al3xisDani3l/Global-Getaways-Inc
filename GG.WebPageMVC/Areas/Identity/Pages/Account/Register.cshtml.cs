...
namespace GG.WebPageMVC.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            UserManager<PrivateUser> userManager,
            SignInManager<PrivateUser> signInManager,
        ...
        public class InputModel
        {
            ...
            [Compare("Password", ErrorMessage = "La contraseña y la contraseña de validacion no son iguales!")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new PrivateUser { UserName = Input.Email, Email = Input.Email };
